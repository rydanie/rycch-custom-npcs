...
SWEP.NPC_SecondaryFireEnt = "obj_vj_rifle_smoke_grenade"
...
SWEP.WorldModel = "models/weapons/tfa_mmod/w_smg1.mdl"--"models/weapons/w_models/w_Cweaponry_ar1_m2.mdl"
SWEP.HoldType = "smg"
SWEP.Spawnable = true
...
SWEP.PrimaryEffects_DynamicLightColor = Color(255,231,135)
...
function SWEP:NPC_SecondaryFire()
	...
	if IsValid(phys) then
		phys:Wake()
		phys:SetVelocity(owner:CalculateProjectile("Line", pos, owner.EnemyData.LastVisiblePos, 800))
	end
