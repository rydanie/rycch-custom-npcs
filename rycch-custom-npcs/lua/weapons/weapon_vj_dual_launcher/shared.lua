...
SWEP.NPC_TimeUntilFireExtraTimers = {0.4, 0.5, 0.6, 0.7} -- Extra timers, which will make the gun fire again! | The seconds are counted after the self.NPC_TimeUntilFire!
	-- Main Settings ---------------------------------------------------------------------------------------------------------------------------------------------
SWEP.ViewModel = "models/weapons/v_models/v_CWeaponry_ar1_m2.mdl"
SWEP.WorldModel = "models/weapons/cup_weapons/w_rocket_launcher.mdl"--"models/weapons/w_models/w_Cweaponry_ar1_m2.mdl"
SWEP.HoldType = "duel"
SWEP.Spawnable = true
