...
ENT.AA_MinWanderDist = -75 -- Minimum distance that the NPC should go to when wandering
...
ENT.AA_GroundLimit = 30 -- If the NPC's distance from itself to the ground is less than this, it will attempt to move up
--ENT.AA_MaxHeight = 50--100
