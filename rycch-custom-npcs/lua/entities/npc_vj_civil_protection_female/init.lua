...
ENT.Model = {"models/police_female_elite.mdl"}
ENT.StartHealth = 50

ENT.FootStepTimeRun = 0.3
ENT.FootStepTimeWalk = 0.5

ENT.AnimTbl_GrenadeAttack = {"ThrowItem"}--"grenadethrow"} -- Grenade Attack Animations
...
ENT.AnimTbl_MeleeAttack = {"MeleeAttack01"} -- Melee Attack Animations--ENT.AnimTbl_MeleeAttack = {"swing"} -- Melee Attack Animations
ENT.TimeUntilMeleeAttackDamage = 0.5 -- This counted in seconds | This calculates the time until it hits something

-- ====== Standing-Firing Variables ====== --
ENT.CanCrouchOnWeaponAttack = true -- Can it crouch while shooting?
ENT.AnimTbl_WeaponAttackCrouch = {ACT_RANGE_AIM_SMG1_LOW} -- Animation played when the SNPC does weapon attack while crouching | For VJ Weapons
