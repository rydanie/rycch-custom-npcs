...
ENT.SoundTbl_OnCollide = {"assault synth/synthblast.wav"}

ENT.OnCollideSoundPitch1 = 100
ENT.OnCollideSoundPitch2 = 110
ENT.OnCollideSoundLevel = 90
---------------------------------------------------------------------------------------------------------------------------------------------
function ENT:CustomOnInitialize()
	self:SetMaterial("models/effects/vol_light001.mdl")
	self:DrawShadow(false)
	self:SetColor(Color(199,132,255,255))
	
	util.SpriteTrail(self, 0, Color(199,132,255,255), false, 105, 0.1, 0.6, 0.01/(10+1)*0.5, "sprites/synthtracer.vmt") //cable/redlaser.vmt
	//util.SpriteTrail(self,6,Color(199,132,255,255),true,6,6,0.1,1/(6+6)*0.5,"VJ_Base/sprites/vj_trial1.vmt")
	//ParticleEffectAttach("vj_rpg1_smoke", PATTACH_ABSORIGIN_FOLLOW, self, 0)
	
	local eyeglow2 = ents.Create("env_sprite")
	eyeglow2:SetKeyValue("model","sprites/synthblast.vmt")
	eyeglow2:SetKeyValue("scale","0.1")
	eyeglow2:SetKeyValue("rendermode","5")
	eyeglow2:SetKeyValue("rendercolor","199 132 255 255")
	...
	self.StartLight1:Fire("Color", "199 132 255 255")
...
function ENT:DeathEffects(data,phys)
	...
	self.ExplosionLight1:Fire("Color", "199 132 255 255")
