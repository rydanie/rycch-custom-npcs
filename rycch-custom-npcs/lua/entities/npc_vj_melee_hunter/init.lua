...
ENT.Model = {"models/stdrht.mdl"}--{"models/VJ_ministrider_Z.mdl"}--"models/stdrht.mdl"--
ENT.StartHealth = 235
...
function ENT:CustomOnInitialize()
    ...
    self.bulletprop1:SetPos(self:GetAttachment(6).Pos + self:GetForward()*6)
...
function ENT:CustomOnThink_AIEnabled()
    ...
    if IsValid(enemy) then
        ...
        --timer.Simple(4,function() self:Shoot() end)
