...
ENT.Model = {"models/DPFilms/Metropolice/rtb_police.mdl"}
ENT.StartHealth = 50
...
ENT.wep = "weapon_vj_mp5k_z"
ENT.WeaponSpread = 2

CanThrowEquipment = CurTime()+20
...
function ENT:DeployManhack()
    ...
    timer.Simple(manhack_deploy_time, function() if IsValid(self) then
        ...
        local manhack = ents.Create("shield_deployer")
...
function ENT:CustomOnThink()
    ...
    if CanThrowEquipment < CurTime() then
        self:SetBodygroup(1, 1) 
        CanThrowEquipment = CurTime() + 20
    end
end
