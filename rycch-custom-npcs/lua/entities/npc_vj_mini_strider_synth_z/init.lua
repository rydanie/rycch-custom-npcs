...
ENT.Model = "models/hl3/ministrider3.mdl"--"models/VJ_ministrider_Z.mdl"
ENT.StartHealth = 235
...
function ENT:CustomOnInitialize()
    ...
    self.bulletprop1:SetPos(self:GetAttachment(5).Pos + self:GetForward()*6)
    self.bulletprop1:SetParent(self,5)
    ...
    self.bulletprop2:SetPos(self:GetAttachment(6).Pos + self:GetForward()*6)
    self.bulletprop2:SetParent(self,6)
...
function ENT:Shoot()
    ...
    --ParticleEffectAttach("vj_rifle_full_blue",PATTACH_POINT_FOLLOW,self,5)
    --ParticleEffectAttach("vj_rifle_full_blue",PATTACH_POINT_FOLLOW,self,6)
