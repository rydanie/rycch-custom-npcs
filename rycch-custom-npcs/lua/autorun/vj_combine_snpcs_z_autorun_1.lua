...
ZippyCombines_NPC_Weapons = {
    npc_vj_overwatch_soldier_z = {"weapon_vj_ar1","weapon_vj_ar_carbine"},--"weapon_vj_smg1","weapon_vj_smg1","weapon_vj_smg1","weapon_vj_ar2"},
    npc_vj_overwatch_soldier_grunt = {"weapon_vj_mp5k_z","weapon_vj_assault_smg"},
    npc_vj_overwatch_soldier_turret = {"weapon_vj_ar_carbine", "weapon_vj_smartsmg"},
    npc_vj_novaprospekt_soldier_z = {"weapon_vj_smartsmg", "weapon_vj_ar1", "weapon_vj_ar2_m"},--"weapon_vj_smg1","weapon_vj_smg1","weapon_vj_smg1","weapon_vj_ar2"},
    npc_vj_novaprospekt_shotgunner_z = {"weapon_vj_spas12_mk2_z"},
    npc_vj_overwatch_shotgunner_z = {"weapon_vj_Heavy_Shotty"},
    npc_vj_civil_protection_z = {"weapon_vj_9mmpistol","weapon_vj_stunstick_z"},
    npc_vj_civil_protection_riot = {"weapon_vj_stunstick_z"},
    npc_vj_civil_protection_elite_z = {"weapon_vj_mp5k_z"},
    npc_vj_overwatch_sniper_z = {"weapon_vj_combine_sniper_rifle_z"},
    npc_vj_overwatch_elite_z = {"weapon_vj_ar2_m"},
    npc_vj_overwatch_synth = {"weapon_vj_ar3","weapon_vj_combine_marksman"},
    npc_vj_overwatch_assassin_z = {"weapon_vj_assassin_pistols_z"},
    npc_vj_overwatch_assassin_melee = {"weapon_vj_assassin_pistols_melee"},
    npc_vj_civil_assault = {"weapon_vj_assault_smg"},
    npc_vj_civil_heavy = {"weapon_vj_ar_heavy"},
    npc_vj_civil_launcher = {"weapon_vj_dual_launcher","weapon_vj_assassin_pistols_z"},
}

local vCat = "RYCCH's Combines"
...
VJ.AddNPC("Melee Hunter Synth","npc_vj_melee_hunter",vCat)
...
VJ.AddNPC("Hopper Mine","obj_vj_hopper_mine_z",vCat)
VJ.AddNPC("Assault Synth","npc_assault_synth_custom",vCat)
...
VJ.AddNPC_HUMAN("Civil Riot Control","npc_vj_civil_protection_riot",ZippyCombines_NPC_Weapons["npc_vj_civil_protection_riot"],vCat)
VJ.AddNPC_HUMAN("Civil Protection Elite","npc_vj_civil_protection_elite_z",ZippyCombines_NPC_Weapons["npc_vj_civil_assault"],vCat)
VJ.AddNPC_HUMAN("Civil Protection Dropshield","npc_vj_civil_protection_dropshield",ZippyCombines_NPC_Weapons["npc_vj_civil_protection_elite_z"],vCat)
VJ.AddNPC_HUMAN("Civil Protection Heavy","npc_vj_civil_protection_heavy",ZippyCombines_NPC_Weapons["npc_vj_civil_heavy"],vCat)
VJ.AddNPC_HUMAN("Civil Protection Elite Female","npc_vj_civil_protection_female",ZippyCombines_NPC_Weapons["npc_vj_civil_assault"],vCat)
VJ.AddNPC_HUMAN("Civil Protection Sniper","npc_vj_civil_protection_sniper",ZippyCombines_NPC_Weapons["npc_vj_overwatch_sniper_z"],vCat)

VJ.AddNPC_HUMAN("Overwatch Medic","npc_vj_overwatch_medic",ZippyCombines_NPC_Weapons["npc_vj_civil_assault"],vCat)
VJ.AddNPC_HUMAN("Overwatch Jumptrooper","npc_vj_overwatch_jumptrooper",ZippyCombines_NPC_Weapons["npc_vj_novaprospekt_soldier_z"],vCat)
VJ.AddNPC_HUMAN("Synth Soldier Shielded","npc_vj_overwatch_dome_shielder_elite",ZippyCombines_NPC_Weapons["npc_vj_overwatch_synth"],vCat)
VJ.AddNPC_HUMAN("Synth Soldier Blinker","npc_vj_overwatch_synth",ZippyCombines_NPC_Weapons["npc_vj_overwatch_synth"],vCat)
VJ.AddNPC_HUMAN("Overwatch Grunt","npc_vj_overwatch_soldier_grunt",ZippyCombines_NPC_Weapons["npc_vj_overwatch_soldier_grunt"],vCat)
VJ.AddNPC_HUMAN("Overwatch Soldier","npc_vj_overwatch_soldier_z",ZippyCombines_NPC_Weapons["npc_vj_overwatch_soldier_z"],vCat)
VJ.AddNPC_HUMAN("Overwatch Soldier Female","npc_vj_overwatch_soldier_female",ZippyCombines_NPC_Weapons["npc_vj_overwatch_soldier_z"],vCat)
VJ.AddNPC_HUMAN("Overwatch Soldier Turret","npc_vj_overwatch_soldier_turret",ZippyCombines_NPC_Weapons["npc_vj_overwatch_soldier_turret"],vCat)
...
VJ.AddNPC_HUMAN("Overwatch Sniper","npc_vj_overwatch_sniper",ZippyCombines_NPC_Weapons["npc_vj_overwatch_sniper_z"],vCat)
VJ.AddNPC_HUMAN("Overwatch Heavy","npc_vj_overwatch_soldier_heavy",ZippyCombines_NPC_Weapons["npc_vj_civil_heavy"],vCat)
VJ.AddNPC_HUMAN("Overwatch Elite","npc_vj_overwatch_soldier_elite",ZippyCombines_NPC_Weapons["npc_vj_overwatch_elite_z"],vCat)
...
VJ.AddNPC_HUMAN("Overwatch Assassin","npc_vj_overwatch_assassin_melee",ZippyCombines_NPC_Weapons["npc_vj_overwatch_assassin_melee"],vCat)
