...
SWEP.WorldModel = "models/weapons/w_irifle1.mdl"
SWEP.HoldType = "ar2"
SWEP.Spawnable = true
...
SWEP.Primary.TracerType = "AirboatGunHeavyTracer" -- Tracer type (Examples: AR2, laster, 9mm)
...
function SWEP:CustomOnPrimaryAttack_BeforeShoot() 
	if NextFireTimer < CurTime() then 
		self.NPC_NextPrimaryFire = math.Rand(0.3, 1.5)
